...
$sql[] = 'CREATE TABLE IF NOT EXISTS `' . _DB_PREFIX_ . 'devisservicemodel_lang` (
  ...
  `libelle5` text NOT NULL,
    `libelle5_1` text NOT NULL,
    `libelle5_2` text NOT NULL,
  `libelle5_3` text NOT NULL,
  `libelle5_4` text NOT NULL,
  `libelle5_1_2` text NOT NULL,`libelle5_1_3` text NOT NULL,
  `libelle5_2_1` text NOT NULL,
  `libelle5_3_1` text NOT NULL,
  `libelle5_3_2` text NOT NULL,
  `libelle5_3_3` text NOT NULL,`libelle5_3_4` text NOT NULL,
